...
class MenuBar(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.menuusername.setGeometry(QtCore.QRect(1720-len("Welcome, " + MainWindow.username)*30, 0, len("Welcome, " + MainWindow.username)*30, 128))
        ...
        self.menuusername.setText(_translate("Form", "Welcome, " + MainWindow.username))
